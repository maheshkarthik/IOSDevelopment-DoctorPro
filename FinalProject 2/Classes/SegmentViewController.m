...
- (void) viewWillAppear:(BOOL)animated
{
	UIBarButtonItem *addButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:
									  UIBarButtonSystemItemBookmarks target:self action:@selector(addEvent:)];
...
- (IBAction)logoutButtonTapped:(id)sender {
	[_session logout];
	UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:@"You are logged out!" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
	[alert show];
	[alert release];
}
...
- (void)postToWall {
	...
	dialog.attachment = [NSString stringWithFormat:@"{\"caption\":\"DiseaseName\",\"description\":'%@',\"media\":[{\"type\":\"image\",\"src\":\"http://img40.yfrog.com/img40/5914/iphoneconnectbtn.jpg\",\"href\":\"http://www.health.ny.gov/diseases/\"}],\"properties\":{\"another link\":{\"text\":\"Disease List\",\"href\":\"http://www.health.ny.gov/diseases/\"}}}",illness.illness];
	[dialog show];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if(segment.selectedSegmentIndex == 0)
	{
			...
			
		{
			...
			[button1 addTarget:self action:@selector(postGradesTapped:)
			  forControlEvents:UIControlEventTouchDown];
			//set the position of the button
			button1.frame = CGRectMake(10.0, 40.0, 300.0, 40.0);
			
			//set the button's title
			[button1 setTitle:@"Connect to Facebook" forState:UIControlStateNormal];
			...
			
		{
			...
			[button2 addTarget:self action:@selector(logoutButtonTapped:)
			  forControlEvents:UIControlEventTouchDown];
			//set the position of the button
			button2.frame = CGRectMake(10.0, 40.0, 300.0, 40.0);
			
			//set the button's title
			[button2 setTitle:@"Logout of Facebook" forState:UIControlStateNormal];
...
-(void)aMethod:(id)sender{
	...
	if([MFMailComposeViewController canSendMail])
	{
		...
		[composer setSubject:illness.illness isHTML:NO];
