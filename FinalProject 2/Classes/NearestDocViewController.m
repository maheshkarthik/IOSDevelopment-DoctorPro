...
@implementation NearestDocViewController
           ...
           fromLocation:(CLLocation *)oldLocation
{
	...
	NSString *searchString =self.speciality ;
	searchString = [searchString stringByAppendingString:@"+specialist"];
	NSLog(@"%@",searchString);
	
	
	//NSString *searchString = [searchStringinitial stringByAppendingString:@" specialist"];
